...
exports.forgotPassword = catchAsyncErrors( async (req, res, next) => {
    ...
    if(!user) {
        return next(new ErrorHandler('User nof found with this email', 404)) 
    }
    ...
    const resetUrl = `${req.protocol}://${req.get('host')}/api/v1/password/resert/${resetToken}`
